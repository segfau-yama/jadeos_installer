    ...
    rsx! {
        div {
            ...
            input {
                ...
                class: "h-14 w-full rounded-[1.35rem] border border-emerald-900/12 bg-white px-4 text-[0.98rem] text-emerald-950 shadow-[inset_0_1px_0_rgba(255,255,255,0.8),0_10px_24px_rgba(12,34,27,0.04)] outline-none transition focus:border-emerald-400/60 focus:ring-4 focus:ring-emerald-100",
